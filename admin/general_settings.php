                            ...
                            <div class="form-group row"><!--- form-group row Starts --->
                                ...
                                <div class="col-md-6">
                                    <select name="approve_buyer_request" class="form-control" required="">
                                        ...
                                        <?php }elseif($approve_buyer_request == 0){ ?>
                                            <option value="0"> No </option>
                                            <option value="1"> Yes </option>
                                        <?php } ?>
                                    </select>
...
<b><i class="fa fa-google"></i></b>
        ...
        if(isset($_POST['general_settings_update'])){
            ...
            $minimum_profile_percentage = $input->post('minimum_profile_percentage');

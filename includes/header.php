      ...
      <div class="modal-body">
        ...
        <form action="" method="post">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="seller_user_name" placeholder="<?= $lang['placeholder']['username_or_email']; ?>"  value= "<?php if(isset($_POST['seller_user_name'])) echo $_POST['seller_user_name']; if(isset($_SESSION['seller_user_name'])) echo $_SESSION['seller_user_name']; ?>" required="">
          </div>
          <div class="form-group">
...
<!--    <script type="text/javascript" src="http://localhost/mystore/js/customjs.js" >-->
<script>
// alert();
...
//                html += "<div class='"+notifications[i].class+"'><a href='"+base_url+"/dashboard?n_id="+notifications[i].id+"'><img src='"+notifications[i].sender_image+"' width='50' height='50' class='rounded-circle'><strong class='heading'>"+notifications[i]['sender_user_name']+ ' '+ notifications[i]['id']+"</strong><p class='message text-truncate'>"+notifications[i].message+"</p><p class='date text-muted'>"+notifications[i].date+"</p></a></div>";
//            }
//            if(parseInt(result.count_all_notifications) > 0){

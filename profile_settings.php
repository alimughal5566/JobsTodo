...
<form method="post" enctype="multipart/form-data" runat="server" autocomplete="off">
  ...
  <div class="form-group row">
        ...
        <div class="col-md-8">
            ...
            <p class="mt-2  ">
                <?= str_replace('{url}', "$site_url/{$_SESSION['seller_user_name']}", $lang['label']['id_passport']); ?>  <small>(<span class="<?=($is_verified_passport==='Approved')?'text-success':'text-danger' ?> "><?php echo $is_verified_passport ?></span>)</small>
            </p>

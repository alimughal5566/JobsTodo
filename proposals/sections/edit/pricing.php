...
<div class="form-group row proposal-price justify-content-center">
  <div class="col-md-7">
    ...
    <?= $s_currency; ?>
        ...
        <input type="number" class="form-control" form="pricing-form" name="proposal_price" min="<?= $min_proposal_price; ?>" value="<?= ($d_proposal_price)?$d_proposal_price:$min_proposal_price; ?>">
